	...
	public AddLocalFlight() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (flightID.getText().equals("") || flightTime.getText().equals("") || landTime.getText().equals("")
						|| departCity.getText().equals("") ||
						landCity.getText().equals("") || economySeats.getText().equals("")
						|| businessSeats.getText().equals("")) {
				...
				Flight obj = new Flight(flightID.getText(), flightTime.getText(), landTime.getText(),
						departCity.getText(), landCity.getText(), economySeats.getText(), businessSeats.getText(),
						distance.getText());
